...
void AssociateExtension()
{
    ...
    std::wstring alias = L"solomonProfile64";
    std::wstring desc = L"solomon 64-bit injection profile";
#else
    std::wstring ext = L".xpr";
    std::wstring alias = L"solomonProfile";
    std::wstring desc = L"solomon injection profile";
#endif 
